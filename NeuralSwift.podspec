...
Pod::Spec.new do |s|
  ...
  s.description  = "Neural network for iOS on swift. try it."

  s.homepage     = "https://github.com/glassonion1/NeuralSwift"
  ...
  s.source       = { :git => "https://github.com/glassonion1/NeuralSwift.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "NeuralSwift/**/*.{h,m,swift}"
